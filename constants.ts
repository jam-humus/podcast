...
export const GENERAL_INTRO: TopicLesson = {
  ...
  quizzes: [
    ...
    { id: 'g6', question: "Warum ist das Grundgesetz wichtig für Kinder in der Schule?", options: ["Damit Erwachsene nur schimpfen können", "Damit Kinder fair und sicher behandelt werden", "Damit es mehr Hausaufgaben gibt"], correctIndex: 1, explanation: "Genau. Es schützt euch zum Beispiel vor Gewalt, Ausgrenzung und unfairer Behandlung." }
  ],
  cases: [
    ...
    { id: 'gc4', title: 'Der Klassenchat', scenario: 'In der Klassengruppe wird über ein Kind gelästert und ein peinliches Bild geteilt. Einige schauen nur zu.', question: "Was ist die beste Reaktion?", options: ["Nichts sagen, sonst gibt es Ärger.", "Stopp sagen, Bild melden/löschen und Hilfe holen."], correctIndex: 1, explanation: "Kinder haben Rechte auf Schutz und Würde. Wegsehen hilft den Betroffenen nicht. Holt euch bei Erwachsenen Unterstützung." }
  ],
  checks: [
    ...
    { id: 'gch3', statement: "Wenn ein Grundrecht verletzt wird, darf ich Hilfe holen?", answer: "yes", explanation: "Ja, unbedingt. Du kannst zu Lehrkraft, Eltern, Schulsozialarbeit oder Vertrauensperson gehen." }
  ]
};
  ...
  art1: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q7', question: "Was hilft am meisten, wenn jemand bloßgestellt wird?", options: ["Mitlachen", "Wegschauen", "Stopp sagen und Hilfe holen"], correctIndex: 2, explanation: "Zivilcourage schützt die Würde. Freundlich helfen und Erwachsene informieren ist stark." }
        ],
        cases: [
            ...
            { id: 'c6', title: 'Das Mut-Video', scenario: 'Zwei Kinder filmen heimlich, wie Leon beim Vorlesen stottert, und wollen das Video posten.', question: "Was ist richtig?", options: ["Video sofort löschen und Leon schützen.", "Hochladen, das ist nur Spaß."], correctIndex: 0, explanation: "Heimliches Filmen und Bloßstellen verletzt Leons Würde. Hilfe holen und das Posten stoppen." }
        ],
        checks: [
            ...
            { id: 'ch5', statement: "Darf ich bei Gemeinheiten im Chat einen Erwachsenen um Hilfe bitten?", answer: "yes", explanation: "Ja. Hilfe holen ist kein Petzen, sondern Schutz für die betroffene Person." }
        ]
    },
  ...
  art2: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q7', question: "Was bedeutet ein klares 'Nein' bei Nähe oder Anfassen?", options: ["Man diskutiert weiter", "Es gilt sofort", "Nur Erwachsene müssen das beachten"], correctIndex: 1, explanation: "Ein Nein muss sofort respektiert werden - bei Kindern und Erwachsenen." }
        ],
        cases: [
            ...
            { id: 'c6', title: 'Das Fangspiel', scenario: 'Beim Fangspiel hält ein Kind ein anderes fest, obwohl es laut „Stopp, ich will das nicht!“ ruft.', question: "Was gilt hier?", options: ["Festhalten ist okay, es ist ja nur Spiel.", "Stopp gilt sofort - loslassen und entschuldigen."], correctIndex: 1, explanation: "Beim Spielen gelten auch Rechte. Ein Stopp schützt den eigenen Körper." }
        ],
        checks: [
            ...
            { id: 'ch5', statement: "Wenn ich mich unsicher fühle, darf ich Hilfe holen?", answer: "yes", explanation: "Ja. Du darfst immer eine erwachsene Vertrauensperson um Hilfe bitten." }
        ]
    },
  ...
  art3: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q7', question: "Was ist besser, wenn jemand ausgeschlossen wird?", options: ["Mitmachen beim Ausgrenzen", "Nichts sagen", "Die Person einladen und fair sein"], correctIndex: 2, explanation: "Wer mit einlädt, sorgt für Gleichbehandlung und stärkt die Klassengemeinschaft." }
        ],
        cases: [
            ...
            { id: 'c6', title: 'Die Teamwahl', scenario: 'Beim Sport bleiben zwei Kinder immer als Letzte übrig. Die anderen stöhnen schon vorher.', question: "Was wäre fair?", options: ["Immer die Schwächsten zuletzt wählen.", "Abwechselnd wählen und freundlich bleiben."], correctIndex: 1, explanation: "Gleichbehandlung heißt auch: Niemand wird absichtlich beschämt oder dauerhaft ausgeschlossen." }
        ],
        checks: [
            ...
            { id: 'ch5', statement: "Darf ich helfen, damit alle mitmachen können?", answer: "yes", explanation: "Ja! Helfen ist fair und sorgt für gleiche Chancen." }
        ]
    },
  ...
  art5: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q7', question: "Was gehört zu freier Meinung dazu?", options: ["Nur reden", "Reden und auch andere ausreden lassen", "Andere anschreien"], correctIndex: 1, explanation: "Meinungsfreiheit gilt für alle. Deshalb hören wir auch andere Meinungen an." }
        ],
        cases: [
            ...
            { id: 'c6', title: 'Die Diskussion', scenario: 'Zwei Kinder haben unterschiedliche Meinungen zu einem Klassenausflug. Eines wird sofort ausgelacht.', question: "Was wäre richtig?", options: ["Auslachen, damit es still ist.", "Argumente anhören und fair widersprechen."], correctIndex: 1, explanation: "Meinungsfreiheit bedeutet auch respektvoll diskutieren - ohne Beleidigung." }
        ],
        checks: [
            ...
            { id: 'ch5', statement: "Darf ich online alles posten, nur weil es meine Meinung ist?", answer: "no", explanation: "Nein. Beleidigungen, Lügen und Hass sind keine erlaubte Meinungsfreiheit." }
        ]
    },
  ...
  art16a: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q7', question: "Was hilft einem neuen Kind am ersten Schultag am meisten?", options: ["Ausfragen über schlimme Erlebnisse", "Ein freundlicher Pate und klare Hilfe", "Ignorieren, bis es Deutsch kann"], correctIndex: 1, explanation: "Ein Pate, einfache Erklärungen und Freundlichkeit geben Sicherheit und Orientierung." }
        ],
        cases: [
            ...
            { id: 'c6', title: 'Der erste Tag', scenario: 'Ein neues Kind steht in der Pause allein neben der Tür und schaut unsicher.', question: "Was passt am besten?", options: ["Ich lade es zum Mitspielen ein und erkläre die Regeln langsam.", "Ich warte, bis es perfekt Deutsch spricht."], correctIndex: 0, explanation: "Willkommen heißen und einfach erklären hilft sofort. So entsteht Sicherheit und Zugehörigkeit." }
        ],
        checks: [
            ...
            { id: 'ch5', statement: "Darf ich 'Willkommen' sagen, auch wenn wir uns noch nicht verstehen?", answer: "yes", explanation: "Ja. Freundlichkeit funktioniert in jeder Sprache und gibt Sicherheit." }
        ]
    },
