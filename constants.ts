...
export const GENERAL_INTRO: TopicLesson = {
  ...
  cases: [
    ...
    { id: 'gc2', title: 'Der Brief', scenario: 'Die Polizei will einfach so deine Post öffnen und lesen.', question: "Dürfen die das?", options: ["Nein, das Postgeheimnis steht im Grundgesetz.", "Ja, die sind neugierig."], correctIndex: 0, explanation: "Das Grundgesetz schützt deine Privatsphäre (Briefgeheimnis)." }
  ],
  checks: [
    { id: 'gch1', statement: "Darf man das Grundgesetz ändern?", answer: "depends", explanation: "Manches ja, aber die wichtigsten Regeln (wie die Menschenwürde) dürfen NIEMALS abgeschafft werden." },
    { id: 'gch2', statement: "Gilt das Grundgesetz auch für Kinder?", answer: "yes", explanation: "Ja! Kinder haben genau die gleichen Grundrechte wie Erwachsene." }
  ]
};
...
export const TOPICS: Record<RightId, PodcastTopic> = {
  art1: {
    ...
    lesson: {
        introStory: "Stell dir vor, du bist auf dem Schulhof. Eine Gruppe älterer Schüler steht im Kreis um Tom. Tom ist in eine Pfütze gefallen und seine Hose ist nass. Anstatt ihm zu helfen, lachen die anderen, machen Fotos und rufen 'Pfützen-Tom'. Tom schämt sich furchtbar. Er fühlt sich ganz klein. Hier sagt das Grundgesetz: STOPP! Das verletzt Toms Würde. Würde heißt: Jeder Mensch ist wertvoll, nur weil er ein Mensch ist. Niemand darf wie Müll behandelt werden.",
        quizzes: [
            ...
            { id: 'q2', question: "Was darf man NIEMALS tun?", options: ["Jemanden auslachen und bloßstellen", "Jemanden kritisieren", "Beim Spielen gewinnen"], correctIndex: 0, explanation: "Richtig. Jemanden fertig zu machen verletzt seine Würde." },
            { id: 'q3', question: "Gilt die Menschenwürde auch für Verbrecher?", options: ["Nein, die sind böse", "Ja, für jeden Menschen", "Nur wenn sie nett sind"], correctIndex: 1, explanation: "Das ist schwer, aber ja: Auch wer etwas Schlimmes getan hat, bleibt ein Mensch und darf nicht gefoltert werden." },
        ...
        cases: [
            ...
            { id: 'c2', title: 'Das Foto', scenario: 'Lisa hat beim Sport eine peinliche Pose gemacht. Mia hat ein Foto davon und will es in die Klassengruppe schicken.', question: "Was soll Mia tun?", options: ["Das Foto löschen.", "Es verschicken, ist doch lustig."], correctIndex: 0, explanation: "Das Foto könnte Lisa bloßstellen. Das verletzt ihre Würde." },
            { id: 'c3', title: 'Die Mutprobe', scenario: 'Die coole Gang sagt zu Paul: "Du darfst nur mitspielen, wenn du aus dem Mülleimer isst." Paul ekelt sich.', question: "Ist das okay?", options: ["Nein, das erniedrigt Paul.", "Klar, ist halt eine Mutprobe."], correctIndex: 0, explanation: "Niemand darf gezwungen werden, sich selbst zu erniedrigen, um dazuzugehören." }
        ],
        checks: [
            { id: 'ch1', statement: "Darf ich lachen, wenn jemand hinfällt?", answer: "depends", explanation: "Wenn dem Kind nichts passiert ist und es selbst lacht: Okay. Wenn es weint: Nein!" },
            { id: 'ch2', statement: "Darf ich jemanden 'Lauch' nennen?", answer: "no", explanation: "Das ist eine Beleidigung und macht den anderen klein." },
            { id: 'ch3', statement: "Darf ich bestimmen, wer neben mir sitzt?", answer: "yes", explanation: "Das ist deine Freiheit, solange du niemanden beleidigst ('Du stinkst')." },
  ...
  art2: {
    ...
    lesson: {
        introStory: "Paul mag es nicht, wenn seine Tante ihn immer fest drückt und abknutscht. Er traut sich nicht, 'Nein' zu sagen, weil sie ja eine Erwachsene ist. Aber Art. 2 sagt: Dein Körper gehört dir! Das nennt man 'Körperliche Unversehrtheit'. Außerdem darf jeder seine Persönlichkeit entfalten – also so sein, wie er will, solange er anderen nicht schadet.",
        quizzes: [
            ...
            { id: 'q2', question: "Was gilt bei 'Stopp'?", options: ["Weitermachen", "Sofort aufhören", "Lachen"], correctIndex: 1, explanation: "Stopp heißt Stopp. Sofort." },
            ...
            { id: 'q4', question: "Darf man jemanden einsperren?", options: ["Ja, aus Spaß", "Nein, Freiheit ist ein hohes Gut", "Nur Lehrer dürfen das"], correctIndex: 1, explanation: "Niemand darf einfach so eingesperrt werden (außer Polizei/Gefängnis mit Grund)." }
        ],
        cases: [
            { id: 'c1', title: 'Der Haarschnitt', scenario: 'Lena möchte sich die Haare kurz schneiden lassen. Ihre Freundin sagt: "Das sieht bestimmt doof aus, mach das nicht!"', question: "Wer entscheidet?", options: ["Die Freundin", "Lena"], correctIndex: 1, explanation: "Es ist Lenas Kopf und ihre Entscheidung (Freie Entfaltung)." },
            { id: 'c2', title: 'Die Rauferei', scenario: 'Ben und Ali raufen aus Spaß. Plötzlich ruft Ali "Aua, Stopp!". Ben macht weiter, weil er gerade gewinnt.', question: "Ist das okay?", options: ["Nein, er muss aufhören.", "Ja, er gewinnt ja gerade."], correctIndex: 0, explanation: "Sobald einer Stopp sagt oder Schmerzen hat, ist die Grenze überschritten." },
            { id: 'c3', title: 'Das Tagebuch', scenario: 'Die Mutter liest heimlich das Tagebuch ihrer Tochter.', question: "Darf sie das?", options: ["Ja, sie ist die Mutter.", "Nein, das gehört zur Persönlichkeit."], correctIndex: 1, explanation: "Auch Kinder haben ein Recht auf Geheimnisse und Privatsphäre." }
        ],
        checks: [
            ...
            { id: 'ch2', statement: "Darf ich jemanden schubsen, der mich nervt?", answer: "no", explanation: "Damit verletzt du seine körperliche Unversehrtheit." },
            { id: 'ch3', statement: "Darf ich 'Nein' sagen, wenn Oma mich küssen will?", answer: "yes", explanation: "Dein Körper, deine Regeln. Ein Handschlag reicht auch." },
  ...
  art3: {
    ...
    lesson: {
        introStory: "Beim Fußball wählen die Kapitäne Teams. 'Mädchen können kein Fußball', sagt einer und lässt Lena stehen, obwohl sie im Verein spielt. Ein anderer Junge wird nicht gewählt, weil er eine Brille trägt. Das ist ungerecht! Art. 3 sagt: Alle Menschen sind vor dem Gesetz gleich. Niemand darf benachteiligt werden, nur weil er ein Junge oder Mädchen ist, woanders herkommt oder anders aussieht.",
        quizzes: [
        ...
        cases: [
            { id: 'c1', title: 'Die Einladung', scenario: 'Tim feiert Geburtstag. Er lädt alle Jungs ein, aber Kevin nicht, weil Kevins Eltern wenig Geld haben und Kevin keine coolen Klamotten trägt.', question: "Ist das fair?", options: ["Ja, ist Tims Party.", "Nein, das ist Ausgrenzung."], correctIndex: 1, explanation: "Kevin wird wegen 'Armut' benachteiligt. Das verletzt den Gedanken von Art. 3." },
            { id: 'c2', title: 'Der Ausflug', scenario: 'Die Klasse plant einen Wandertag. Es gibt einen steilen Weg. Ein Kind im Rollstuhl kann da nicht mit.', question: "Was tun?", options: ["Das Kind bleibt daheim.", "Wir suchen einen Weg für alle."], correctIndex: 1, explanation: "Gleichberechtigung heißt: Wir lassen niemanden zurück." },
        ...
        checks: [
            { id: 'ch1', statement: "Darf ich sagen: Jungs sind stärker als Mädchen?", answer: "no", explanation: "Das ist ein Vorurteil und stimmt so nicht pauschal." },
  ...
  art5: {
    ...
    lesson: {
        introStory: "Tim sagt im Unterricht: 'Ich finde das Projekt langweilig.' Der Lehrer schimpft: 'Sei still! Deine Meinung interessiert nicht.' Darf der Lehrer das? Nein! Art. 5 schützt unsere Meinung. In Deutschland darf jeder sagen, schreiben oder malen, was er denkt. Es gibt keine Zensur (das heißt, der Staat darf Zeitungen nicht verbieten). Aber Vorsicht: Es gibt einen Unterschied zwischen einer Meinung und einer Beleidigung!",
        quizzes: [
            ...
            { id: 'q3', question: "Wo darf man seine Meinung sagen?", options: ["Überall (Schule, Internet, Straße)", "Nur im Keller", "Nur wenn man leise flüstert"], correctIndex: 0, explanation: "Meinungsfreiheit gilt überall, auch bei Demos auf der Straße." },
        ...
        cases: [
            { id: 'c1', title: 'Das Bild', scenario: 'Mia hat ein Bild gemalt. Leo findet es hässlich. Er sagt: "Das ist das hässlichste Gekritzel der Welt, du kannst gar nix!"', question: "Ist das eine Meinung?", options: ["Ja, er ist ehrlich.", "Nein, das ist beleidigend."], correctIndex: 1, explanation: "Er hätte sagen können: 'Mir gefällt es nicht so gut.' Das wäre okay." },
            { id: 'c2', title: 'Die Lüge', scenario: 'Jemand erzählt in der Pause: "Die neue Lehrerin isst Regenwürmer!" Alle lachen.', question: "Ist das Meinungsfreiheit?", options: ["Nein, das ist eine Lüge.", "Ja, kann man doch sagen."], correctIndex: 0, explanation: "Lügen verbreiten (Fake News) ist nicht von der Meinungsfreiheit geschützt." },
            { id: 'c3', title: 'Die Demo', scenario: 'Schüler malen Plakate: "Wir wollen besseres Essen in der Mensa!" und stellen sich auf den Schulhof.', question: "Dürfen die das?", options: ["Nein, Kinder müssen still sein.", "Ja, das ist eine Demonstration."], correctIndex: 1, explanation: "Seine Meinung gemeinsam zu zeigen (versammeln) ist ein Grundrecht." }
        ],
        checks: [
            { id: 'ch1', statement: "Darf ich sagen, dass ich Mathe hasse?", answer: "yes", explanation: "Das ist deine persönliche Meinung und dein Gefühl." },
            { id: 'ch2', statement: "Darf ich zum Lehrer 'Dummkopf' sagen?", answer: "no", explanation: "Das ist eine Beleidigung und respektlos." },
            { id: 'ch3', statement: "Darf ich sagen: 'Ich finde deine Schuhe nicht schön'?", answer: "yes", explanation: "Das ist eine Meinung. Aber man kann es auch netter sagen." },
  ...
  art16a: {
    ...
    lesson: {
        ...
        quizzes: [
            ...
            { id: 'q4', question: "Ist es leicht, die Heimat zu verlassen?", options: ["Ja, macht Spaß", "Nein, man vermisst alles", "Egal"], correctIndex: 1, explanation: "Die meisten Menschen wären lieber zu Hause, wenn es dort sicher wäre." }
        ],
        cases: [
            { id: 'c1', title: 'Die Sprache', scenario: 'Ein neues Kind spricht kein Deutsch. Manche Kinder verdrehen die Augen, weil das Spielen so kompliziert ist.', question: "Wie reagierst du?", options: ["Ich spiele nicht mit ihm.", "Ich zeige mit Händen, wie es geht."], correctIndex: 1, explanation: "Man kann auch ohne Worte spielen. Das Kind freut sich riesig über Anschluss." },
            { id: 'c2', title: 'Vorurteile', scenario: 'Jemand sagt: "Die Flüchtlinge nehmen uns alles weg!"', question: "Stimmt das?", options: ["Ja, habe ich gehört.", "Nein, das ist ein Vorurteil."], correctIndex: 1, explanation: "Menschen suchen Schutz. Wir haben genug, um zu teilen. Vorurteile machen Angst." },
            { id: 'c3', title: 'Das Trauma', scenario: 'Ali erschrickt sehr laut, als eine Tür zuknallt.', question: "Warum?", options: ["Er ist ein Angsthase.", "Das Geräusch erinnert ihn an den Krieg."], correctIndex: 1, explanation: "Viele Flüchtlinge haben schlimme Dinge erlebt und sind deshalb schreckhaft." }
        ],
        checks: [
            { id: 'ch1', statement: "Darf ich fragen, warum jemand geflohen ist?", answer: "depends", explanation: "Ja, aber sei vorsichtig. Manche Erinnerungen sind sehr traurig." },
            ...
            { id: 'ch3', statement: "Darf ich mein Pausenbrot teilen?", answer: "yes", explanation: "Das ist eine super nette Geste!" },
            { id: 'ch4', statement: "Müssen Flüchtlinge für immer bleiben?", answer: "depends", explanation: "Viele wollen zurück, wenn der Krieg vorbei ist. Manche bleiben auch hier." }
        ]
    },
